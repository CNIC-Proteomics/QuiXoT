...
namespace QuiXoT
{
    partial class AboutBox : Form
    {
        public AboutBox()
        {
            ...
            this.label2.Text = "QuiXoT v" + QuiXoT.Properties.Settings.Default.version;
        ...
        private void labelAuthorsTitle_Click(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://www.cnic.es/wiki/proteomica/index.php/QuiXoT_software_package");
        }
