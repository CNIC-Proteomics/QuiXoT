    ...
    public class NTPClient
    {
					...
					case _Stratum.SecondaryReference:
						switch(VersionNumber)
						{
							case 3:	// Version 3, Reference ID is an IPv4 address
								...
								try
									{
                                        IPHostEntry Host = Dns.GetHostEntry(Address); //Obsolet: Dns.GetHostByAddress(Address);
        ...
        public void Connect(bool UpdateSystemTime)
        {
            ...
            try
            {
                ...
                IPHostEntry hostadd = Dns.GetHostEntry(TimeServer); //Obsolete: Dns.Resolve(TimeServer);
